...
namespace alltdl.Events
{
    ...
    {
        public BaseEventArgs(string message)
        {
            Message = message;
        }
    ...
    public class Publisher
    {
        ...
        public event EventHandler<BaseEventArgs>? RaiseBaseEvent;
        ...
        protected virtual void OnRaiseBaseEvent(BaseEventArgs e)
        {
            ...
            // event is raised.
            EventHandler<BaseEventArgs>? raiseEvent = RaiseBaseEvent;
    ...
    internal class Subscriber
    {
        public Subscriber(string id, Publisher pub)
        {
            ...
            pub.RaiseBaseEvent += HandleCustomEvent!;
        }
